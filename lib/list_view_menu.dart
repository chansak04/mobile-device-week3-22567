...
List<ListMenu> menus = [
  ...
  const ListMenu(title: 'MENU-1', subtitle: 'SUB-1', icon: Icons.person_add),
  const ListMenu(title: 'MENU-1', subtitle: 'SUB-1', icon: Icons.wifi),
  const ListMenu(title: 'MENU-1', subtitle: 'SUB-1', icon: Icons.build),
];
